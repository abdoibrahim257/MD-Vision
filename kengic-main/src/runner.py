...
coco_splits_path = 'dataset_coco.json'
...
parser.add_argument('--optimiser',        default=2,  type=int, help='optimiser [1,2,3,4] (default: 1)')
parser.add_argument('--i',                default=150, type=int, help='traversal iterations (default: 150)') #was 150
...
parser.add_argument('--top-n-captions',   default=20,  type=int, help='number of captions to be considered during caption generation (default: 5')
parser.add_argument('--num-processes',    default=1,  type=int, help='number of processes (default: 1)')
